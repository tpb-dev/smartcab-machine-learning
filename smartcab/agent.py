...
class LearningAgent(Agent):
    ...
    def createQ(self, state):
        ...
        if self.learning and not state in self.Q:
            action_scores = dict(zip(self.valid_actions, [0.0] * len(self.valid_actions)))
...
def run():
    ...
    agent = env.create_agent(LearningAgent, learning=True, epsilon=0.5, alpha=1)
